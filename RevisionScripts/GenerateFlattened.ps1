...
Intent
	The output of running this can be used with latexdiff e.g.
		```
		latexdiff Thesis_flat.tex Thesis.tex > Thesis_diff.tex
		```
		where Thesis_flat.tex is the output of running this script on the version that was submitted for review
		and Thesis.tex is the revised version
...
# Filename for output
$fileFlat = 'Revisions\Thesis_flat'
