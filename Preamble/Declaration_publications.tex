...
\begin{center}
    ...
    \begin{NiceTabular}[colortbl-like]
        ...
        \hline
        \Block[v-center]{1-1}{\ref{chap:article1}} &
        \Block[v-center]{1-1}{\formatVspace{The Title of My First Published Article}} &
        \Block[v-center]{1-1}{Published} &
        \Block[v-center]{1-1}{(70\%)} &
        \Block[v-center]{1-1}{\formatVspace{
            NAME (10\%)\\
            NAME (10\%)\\
            NAME (5\%)\\
            NAME (5\%)%% This comment prevents unwanted spaces
            }} & \Block[v-center]{1-1}{No\\No\\No\\No}\\
        \hline
        \Block[v-center]{1-1}{\ref{chap:article2}} &
        \Block[v-center]{1-1}{\formatVspace{The Title of My Second Published Article}} &
        \Block[v-center]{1-1}{In Press} &
        \Block[v-center]{1-1}{(80\%)} &
        \Block[v-center]{1-1}{\formatVspace{
            NAME (10\%)\\
            NAME (10\%)%% This comment prevents unwanted spaces
            }} & \Block[v-center]{1-1}{No\\No}\\
        \hline
    \end{NiceTabular}
\end{center}
